...
int main() {
    ...
    for (int s = 0; s < numSizes; s++) {
        ...
        for (int i = 0; i < size * size; i++) {
            float denominator = fmax(fabs(C_cpu[i]), fabs(C_gpu[i]));
            float relative_error = denominator > 0.0f
                ? fabs(C_cpu[i] - C_gpu[i]) / denominator
                : 0.0f;
...
# OUTPUT:
<img width="628" height="297" alt="Screenshot 2026-09-05 134702" src="https://github.com/user-attachments/assets/43b60d8d-36f2-4e9b-b619-e5a99f132aac" />
